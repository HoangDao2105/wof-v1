import { Application, BlurFilter, Container, Graphics, Point, Sprite, Ticker } from "pixi.js";
...
import { ConfigSetting } from "./screens/popup/ConfigSetting";
...
export class Manager {
    ...
    private static configSetting: ScreenContainer | undefined;
    ...
    public static toggleSetConfig(value: boolean) {
        if (value) {
            Manager.currentScreen.interactiveChildren = false;
            if (Manager.currentScreen.blur) {
                Manager.currentScreen.blur();
            }
            Manager.configSetting = new ConfigSetting();
            Manager.app.stage.addChild(Manager.configSetting);
        } else {
            Manager.currentScreen.interactiveChildren = true;
            if (Manager.configSetting) {
                Manager.configSetting.destroy();
                Manager.app.stage.removeChild(Manager.configSetting);
            }
            if (Manager.currentScreen.focus) {
                Manager.currentScreen.focus();
            }
